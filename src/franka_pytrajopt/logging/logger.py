...
class ResultLogger:
    ...
    def _append_metrics(
        ...
        row = {
            ...
            "sampled_min_signed_distance": metrics["sampled_min_signed_distance"],
            "sampled_max_penetration_depth": metrics["sampled_max_penetration_depth"],
            "sampled_collision_penalty": metrics["sampled_collision_penalty"],
            "constraint_violation": metrics["constraint_violation"],
            "has_segment_collision": int(metrics["has_segment_collision"]),
            "colliding_segments": "|".join(str(idx) for idx in metrics["colliding_segments"]),
            "step_norm": step_norm,
